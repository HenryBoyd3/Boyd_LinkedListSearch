    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("2.See total number of names");
                Console.WriteLine("3.See total number of male names");
                Console.WriteLine("4.See total number of female names");
                Console.WriteLine("5.add a name");
                Console.WriteLine("6.see most popular male name");
                Console.WriteLine("7.see most popular female name");
